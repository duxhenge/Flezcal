...
extension FoodCategory {
    ...
    static let mole = FoodCategory(
        ...
        mapSearchTerms: ["mole", "oaxacan restaurant", "mexican restaurant", "mole poblano"],
    ...
    static let ramen = FoodCategory(
        ...
        mapSearchTerms: ["ramen", "ramen shop", "ramen restaurant", "japanese restaurant", "noodle restaurant"],
    ...
    static let omakase = FoodCategory(
        ...
        mapSearchTerms: ["omakase", "sushi restaurant", "sushi bar", "japanese restaurant", "fine dining"],
    ...
    static let pho = FoodCategory(
        ...
        mapSearchTerms: ["pho", "pho restaurant", "vietnamese restaurant", "vietnamese food"],
    ...
    static let paella = FoodCategory(
        ...
        mapSearchTerms: ["paella", "spanish restaurant", "tapas bar", "tapas", "mediterranean restaurant"],
    ...
    static let ibericoHam = FoodCategory(
        ...
        mapSearchTerms: ["iberico", "jamon iberico", "spanish restaurant", "tapas bar", "tapas", "wine bar"],
    ...
    static let tartare = FoodCategory(
        ...
        mapSearchTerms: ["steak tartare", "tartare", "french restaurant", "bistro", "fine dining"],
    ...
    static let caviar = FoodCategory(
        ...
        mapSearchTerms: ["caviar", "seafood restaurant", "fine dining", "oyster bar", "wine bar"],
    ...
    static let amaro = FoodCategory(
        ...
        mapSearchTerms: ["amaro", "cocktail bar", "italian restaurant", "wine bar", "liquor store", "wine spirits"],
    ...
    static let kombucha = FoodCategory(
        ...
        mapSearchTerms: ["kombucha", "kombucha bar", "juice bar", "health food"],
    ...
    static let cider = FoodCategory(
        ...
        mapSearchTerms: ["cider", "cidery", "cider house", "hard cider", "taproom", "liquor store", "wine spirits"],
    ...
    static let baklava = FoodCategory(
        ...
        mapSearchTerms: ["baklava", "turkish bakery", "middle eastern bakery", "mediterranean restaurant", "middle eastern restaurant"],
    ...
    static let empanadas = FoodCategory(
        ...
        emoji: "🥟",
        color: Color(red: 0.8, green: 0.5, blue: 0.1),
        mapSearchTerms: ["empanadas", "empanada shop", "argentine restaurant", "colombian restaurant", "latin american restaurant"],
    ...
    static let crepes = FoodCategory(
        ...
        mapSearchTerms: ["crepes", "creperie", "french cafe", "french bakery", "brunch"],
